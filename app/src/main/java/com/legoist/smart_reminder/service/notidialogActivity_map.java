...
public class notidialogActivity_map extends Activity{
	Intent intent;
	String getNotiCarry;
	DB_Item im;
	DB_setting sdb;
...
//		String longitude = String.valueOf(location.getLongitude()).substring(0,6);
        ...
        Adapter = new ArrayAdapter<String>(notidialogActivity_map.this, android.R.layout.simple_list_item_1, iNameList);
	...
	public void notidialogClick(View v){
		...
		case R.id.notidialog_stop_btn:	
			Intent stopServiceIntent = new Intent(notidialogActivity_map.this, com.legoist.Smart_Reminder.Service.mapService.class);
			stopService(stopServiceIntent);
			
			//알람 종료
			AlarmManager am = (AlarmManager)getSystemService(Context.ALARM_SERVICE);
			PendingIntent sender;		
			intent = new Intent(notidialogActivity_map.this, com.legoist.Smart_Reminder.Service.AlarmReceiver.class);
			...
			intent = new Intent(notidialogActivity_map.this, MainActivity.class);
			PendingIntent content = PendingIntent.getActivity(getBaseContext(), 0, intent, 0);
			notioff.setLatestEventInfo(notidialogActivity_map.this, "Smart Reminder", "매니저 작동을 중단했습니다.", content);
			mNotiManager.notify(notidialogActivity_map.noti_id, notioff);
			
//			ComponentName Widget = new ComponentName(notidialogActivity_map.this,Widget.class);
...
//			awm.updateAppWidget(Widget, views);
			...
			SharedPreferences pref = getSharedPreferences("mapService", 0);
